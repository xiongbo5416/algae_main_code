...
temp_f, temp_l = get_lensf_feastures(A_lensf,0,0.2,1)
Features_lensf_train=temp_f
labels_lensf_train=temp_l

temp_f, temp_l = get_lensf_feastures(B_lensf,0,0.2,2)
...
temp_f, temp_l = get_lensf_feastures(C_lensf,0,0.05,3)
Features_lensf_train=np.append(Features_lensf_train,temp_f,axis=0)
labels_lensf_train=np.append(labels_lensf_train,temp_l,axis=0)
...
#test
temp_f, temp_l = get_lensf_feastures(A_lensf,0.2,1)
#temp_f, temp_l = get_lensf_feastures(B_lensf,0.1,1)
#C_fl_predictions = model_fl.predict(temp_f)
lensf_predictions = model_lensf.predict_proba(temp_f)

lensf_predictions[:,0].sum()
lensf_predictions[:,1].sum()
lensf_predictions[:,2].sum()
